...
-> **Data Cleaning of Uploaded Entries**
...
| `BFPO No` | ✅ Yes (column must exist; values may be blank) | `BF2` | British Forces Post Office number (typically empty for U.S.-based donors). |
| `Postcode` | ✅ Yes (column must exist; values may be blank) | `12561` or `BF2 0LP` | Postal / ZIP code. Used to improve geocoding when available. |
